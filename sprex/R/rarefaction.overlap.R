...
#' 
#' @param x,y two vectors of species frequencies where \code{f[i]} is the 
...
#'   amd the sample size and species estimates for the \code{x} and 
#'   \code{y} vectors.
#' 
